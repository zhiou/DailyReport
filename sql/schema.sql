...
CREATE TABLE `product` (
     ...
     `deleted` tinyint(2) NOT NULL DEFAULT '0' COMMENT '删除状态',
      PRIMARY KEY (`id`) USING BTREE,
      FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8;
...
CREATE TABLE `department` (
    ...
    `deleted` tinyint(2) NOT NULL DEFAULT '0' COMMENT '删除状态',
    PRIMARY KEY (`id`) USING BTREE,
    FOREIGN KEY (`parent_id`) REFERENCES `department` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8;
...
CREATE TABLE `task` (
    ...
    FOREIGN KEY (`in_report`) REFERENCES `report` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8;
